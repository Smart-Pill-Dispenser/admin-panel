    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center justify-end gap-3 border-b bg-background/95 px-6 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <span className="text-sm font-medium text-muted-foreground">{t("layout.headerSubtitle")}</span>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              <div className="p-3 pb-2">
                <p className="text-sm font-medium text-foreground">{user?.name ?? t("layout.userFallback")}</p>
